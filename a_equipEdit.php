		...
		if(empty($alert)) {
			...
			if(nameExist('equips', $name) && $name !== $row['name']) {
				...
				if(empty($alert)) {			
					...
					if(ubahData('equips',$dataAlat, 'eq_id', $id)) {
						$alert[] = "Data alat berhasil diubah <i class='icon fa-smile-o'></i>";
					} else {
						$alert[] = "Data alat gagal disimpan! <i class='icon fa-frown-o'></i>";
					}
				}
		...
		<div class="row">
			<div class="4u 12u(mobile)">
				<div class="box special">							
					<ul class="alt">
					<li><h3 class="icon fa-edit"> Data Alat</h3></li>
